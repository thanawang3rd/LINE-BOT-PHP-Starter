...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			$hello=array("จ้าาาาา","อยู่จ้าา","อีหยัง","ว่าจั๊งได๋","เฮ็ดหยังจ้า","เฮ็ดหยังท้าว","บ่องชู","โคนิชิวะ");
			$lotto_ans=array("บ่ถึก","กินเต็มจ้า","ซาวบาท","บ่เว่าเรื่องหวย","เบิดคำซิเว่า","ผู้หญิงอย่าหยุดหวย","ลืมกลับเลข");
			$default_rep=array("ฮ่วย","คั่ก","อีหลี","ถามพี่ฝนเด๊ะ","บ่รู้ไปนอนนามา","ถามน้องว่านเด๊ะ","ถามนุชเด๊ะ");
			$fon_rep=array("งามหลาย","งามคั่ก","สายแข็ง","ป๊อกแปดสองเด้ง","ถึกหวย","ปั่นยานเก่งหลาย","ปั่นยานไส้แตก","เสียไพ่","ได้ไพ่ห้าร้อย");
